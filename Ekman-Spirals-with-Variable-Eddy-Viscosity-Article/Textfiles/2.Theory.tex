...
For a theoretically or numerically derived solution, one can derive the Ekman transport, which may be a more useful quantity. The Ekman transport is defined as the mass flux per meter for the entire Ekman spiral. In the classical solution the Ekman transport is \SI{90}{\degr} to the right of the geostrophic flow. However, for an obtained solution $U(\tilde z, \varphi)$ as a function of the dimensionless height and layer thickness, one can obtain the mass flux as 
\begin{equation}
