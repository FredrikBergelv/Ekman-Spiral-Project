...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 25 10:23:32 2025
...
# -------------------------
def nu(z, L1=10, L2=100):
    """
    Step function of nu.
    Works for scalar z or numpy array.
    """
    z = np.asarray(z) 
...
#plt.savefig("Notes_Ekman_spiral/Figures/BVP_step.png",dpi=400)
#plt.savefig("Notes_Ekman_spiral/Figures/nice figures/BVP_step.png",dpi=400)